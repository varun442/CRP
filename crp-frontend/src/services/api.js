...
export const getUserAllPoints = async (userId) => {
    try {
        const response = await axios.get(`${API_URL}/users/points/all/${userId}`);
        return response.data;
    } catch (error) {
...
export const submitRecognition = async (recognitionData) => {
    try {
        const response = await axios.post(`${API_URL}/recognition/submit`, recognitionData);
        return response.data;
    } catch (error) {
...
export const getAllRecognitions = async () => {
    try {
        const response = await axios.get(`${API_URL}/recognition/`);
        return response.data;
    } catch (error) {
...
export const getAllRecognitionsForUser = async (userId) => {
    try {
        const response = await axios.get(`${API_URL}/recognition/all/${userId}`);
        return response.data;
    } catch (error) {
